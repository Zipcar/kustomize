...
func TestArmadaCRDMergeTransformerMissingFile(t *testing.T) {
	tc := plugins_test.NewEnvForTest(t).Set()
	defer tc.Reset()

	tc.BuildGoPlugin(
		"armada.airshipit.org", "v1alpha1", "ArmadaCRDMergeTransformer")
	th := kusttest_test.NewKustTestPluginHarness(t, "/app")

	_, err := th.RunTransformer(`
apiVersion: armada.airshipit.org/v1alpha1
kind: ArmadaCRDMergeTransformer
metadata:
...
func TestBadArmadaCRDMergeTransformer(t *testing.T) {
	tc := plugins_test.NewEnvForTest(t).Set()
	defer tc.Reset()
...
func TestBothEmptyArmadaCRDMergeTransformer(t *testing.T) {
	tc := plugins_test.NewEnvForTest(t).Set()
	defer tc.Reset()
...
func TestArmadaCRDMergeTransformerFromFiles(t *testing.T) {
	tc := plugins_test.NewEnvForTest(t).Set()
	defer tc.Reset()
...
func TestArmadaCRDMergeTransformerWithInlineJSON(t *testing.T) {
	tc := plugins_test.NewEnvForTest(t).Set()
	defer tc.Reset()
...
func TestArmadaCRDMergeTransformerWithInlineYAML(t *testing.T) {
	tc := plugins_test.NewEnvForTest(t).Set()
	defer tc.Reset()
...
func TestArmadaCRDMergeTransformerMultiplePatches(t *testing.T) {
	tc := plugins_test.NewEnvForTest(t).Set()
	defer tc.Reset()
...
func TestArmadaCRDMergeTransformerPatchDelete(t *testing.T) {
	tc := plugins_test.NewEnvForTest(t).Set()
	defer tc.Reset()
