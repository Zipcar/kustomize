...
kustomize build ${DEMO_HOME} --reorder=kubectlapply --enable_alpha_plugins -o ${DEMO_HOME}/actual/reorder.kubectlapply.yaml
kustomize build ${DEMO_HOME} --reorder=kubectldelete --enable_alpha_plugins -o ${DEMO_HOME}/actual/reorder.kubectldelete.yaml
```
